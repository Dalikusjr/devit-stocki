<div class="card">
                <div class="card-datatable table-responsive pt-0">
                  <table class="datatables-abonnvie table-striped table">
                    <thead>
                      <tr>
                        <th></th>
                        <th>id</th>
            ...
            <div class="offcanvas offcanvas-end" id="add-new-record">
              ...
              <div class="offcanvas-body flex-grow-1">
                ...
                >
                  ...
                  <div class="col-sm-12">
                    <label class="form-label" for="resteApayer"
                      >Reste à payé</label
                    >
                    <div class="input-group input-group-merge">
                      <span id="resteApayer2" class="input-group-text"
                        ><i class="ti ti-calendar-check"></i
                      ></span>
                      <input
                        type="number"
                        id="resteApayer"
                        name="resteApayer"
                        class="form-control dt-resteApayer"
                        aria-describedby="resteApayer2"
                        placeholder="Montant TND"
                        aria-label="Montant TND"
                      />
                    </div>
