        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-4">
              <img class="w-100" src="assets/img/branding/brand.png" alt="" />
            </div>
            <!-- /Logo -->
                     <!-- Affichage d'erreur session -->
        <?php if (!empty($_SESSION['error'])): ?>
            <div id="msgErreur" class="alert alert-danger f-flou-danger border-0">
                <i class="ti ti-x me-3"></i>
                <?= htmlspecialchars($_SESSION['error']) ?>
            </div>
            <?php unset($_SESSION['error']); ?>
        <?php endif; ?>
            <h3 class="mb-2">Bienvenue à DevStock! 👋</h3>
            <form
              id="formAuthentication"
              class="mb-3"
              action="dashboard/log/login.php"
              method="POST"
            >
              <div class="mb-3">
